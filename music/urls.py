...
from music.views import GetTopCharts, GetSongByGerneName, GetSongBySearchName, GetArtistDetails, GetSongDetailsById, GetSongRelated, GetAlbumList, UpdateTrackViews
