...
| `/user/<int:id>/albums/create/`                  | POST   | Path params: `user_id`, form-data: `name`, `image (file upload)`               | Create a new custom album. The album_id is auto-generated. Example: `/user/3/albums/create/`.                                |
