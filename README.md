...
| `/music/artist/details/<str:artist_name>/`       | GET    | `artist_name` in URL path                                  | Get songs by artist. Example: `/artist/eminem/`. Returns artist details and a list of their top tracks and albums.        |
| `/music/tracks/tracksdetail/<int:track_id>/`     | GET    | `track_id` in URL path                                     | Get full details of a specific song and related songs by ID. Example: `/tracksdetail/8/`.                                 |
| `/music/tracks/tracksdetail/<str:track_name>/`   | GET    | `track_name` in URL path                                   | Get full details of a specific song related songs by Name. Example: `/tracksdetail/Here with Me/`.                        |
